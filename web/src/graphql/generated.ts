...
export type Mutation = {
  ...
  createUserText: CustomText
  deleteUserText: Scalars['Boolean']
...
export type MutationCreateUserTextArgs = {
  id: Scalars['String']
  text: Scalars['String']
  title: Scalars['String']
}

export type MutationDeleteUserTextArgs = {
  id: Scalars['String']
}
...
export type Query = {
  ...
  settings: Settings
  speech: Scalars['String']
  text: Text
  textIds: Array<Scalars['ID']>
  texts: Array<Text>
  user?: Maybe<User>
  userText: CustomText
  userTexts: Array<CustomText>
}
...
export type DeleteUserTextMutationVariables = Exact<{
  id: Scalars['String']
}>

export type DeleteUserTextMutation = { deleteUserText: boolean }
...
export type UserTextQuery = {
  userText: { id: string; title: string; text: string; user: { id: string } }
}

export type CreateUserTextMutationVariables = Exact<{
  id: Scalars['String']
  title: Scalars['String']
  text: Scalars['String']
}>

export type CreateUserTextMutation = {
  createUserText: { id: string; title: string; text: string }
}
...
`
export const DeleteUserText = gql`
  mutation DeleteUserText($id: String!) {
    deleteUserText(id: $id)
  }
`
export const UserTexts = gql`
  query UserTexts {
    userTexts {
      id
      title
...
`
export const UserText = gql`
  query UserText($id: String!) {
    userText(id: $id) {
      id
      title
      text
...
`
export const CreateUserText = gql`
  mutation CreateUserText($id: String!, $title: String!, $text: String!) {
    createUserText(id: $id, title: $title, text: $text) {
      id
      title
      text
    }
...
export const EntryDocument = `
    query Entry(`
export const useEntryQuery = <TData = EntryQuery, TError = unknown>(
...
useEntryQuery.fetcher = (variables: EntryQueryVariables) =>
  fetcher<EntryQuery, EntryQueryVariables>(EntryDocument, variables)
...
export const AuthorsDocument = `
  ...
  authors {
    ...
    `
export const useAuthorsQuery = <TData = AuthorsQuery, TError = unknown>(
...
useAuthorsQuery.getKey = (variables?: AuthorsQueryVariables) => [
  'Authors',
  variables,
]

useAuthorsQuery.fetcher = (variables?: AuthorsQueryVariables) =>
  fetcher<AuthorsQuery, AuthorsQueryVariables>(AuthorsDocument, variables)
...
export const AuthorDocument = `
  ...
  author(id: $id) {
    ...
    `
export const useAuthorQuery = <TData = AuthorQuery, TError = unknown>(
...
useAuthorQuery.getKey = (variables: AuthorQueryVariables) => [
  'Author',
  variables,
]

useAuthorQuery.fetcher = (variables: AuthorQueryVariables) =>
  fetcher<AuthorQuery, AuthorQueryVariables>(AuthorDocument, variables)
export const TextDocument = `
  ...
  text(id: $id) {
    ...
    `
export const useTextQuery = <TData = TextQuery, TError = unknown>(
...
useTextQuery.fetcher = (variables: TextQueryVariables) =>
  fetcher<TextQuery, TextQueryVariables>(TextDocument, variables)
export const TextIdsDocument = `
  ...
  textIds
    ...
    `
export const useTextIdsQuery = <TData = TextIdsQuery, TError = unknown>(
...
useTextIdsQuery.getKey = (variables?: TextIdsQueryVariables) => [
  'TextIds',
  variables,
]

useTextIdsQuery.fetcher = (variables?: TextIdsQueryVariables) =>
  fetcher<TextIdsQuery, TextIdsQueryVariables>(TextIdsDocument, variables)
export const TextsDocument = `
  ...
  texts {
    ...
    `
export const useTextsQuery = <TData = TextsQuery, TError = unknown>(
...
useTextsQuery.fetcher = (variables?: TextsQueryVariables) =>
  fetcher<TextsQuery, TextsQueryVariables>(TextsDocument, variables)
export const DeleteUserTextDocument = `
    mutation DeleteUserText($id: String!) {
  deleteUserText(id: $id)
}
    `
export const useDeleteUserTextMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
    DeleteUserTextMutation,
    TError,
    DeleteUserTextMutationVariables,
    TContext
  >
) =>
  useMutation<
    ...
    TContext
  >(
    (variables?: DeleteUserTextMutationVariables) =>
      fetcher<DeleteUserTextMutation, DeleteUserTextMutationVariables>(
        DeleteUserTextDocument,
        variables
      )(),
    options
  )
export const UserTextsDocument = `
    query UserTexts {
  userTexts {
    id
    title
    ...
    `
export const useUserTextsQuery = <TData = UserTextsQuery, TError = unknown>(
  variables?: UserTextsQueryVariables,
  options?: UseQueryOptions<UserTextsQuery, TError, TData>
) =>
  useQuery<UserTextsQuery, TError, TData>(
    ['UserTexts', variables],
    fetcher<UserTextsQuery, UserTextsQueryVariables>(
      UserTextsDocument,
      variables
    ),
    options
  )
useUserTextsQuery.getKey = (variables?: UserTextsQueryVariables) => [
  'UserTexts',
  variables,
]

useUserTextsQuery.fetcher = (variables?: UserTextsQueryVariables) =>
  fetcher<UserTextsQuery, UserTextsQueryVariables>(UserTextsDocument, variables)
export const UserTextDocument = `
    query UserText($id: String!) {
  userText(id: $id) {
    id
    title
    ...
    `
export const useUserTextQuery = <TData = UserTextQuery, TError = unknown>(
  variables: UserTextQueryVariables,
  options?: UseQueryOptions<UserTextQuery, TError, TData>
) =>
  useQuery<UserTextQuery, TError, TData>(
    ['UserText', variables],
    fetcher<UserTextQuery, UserTextQueryVariables>(UserTextDocument, variables),
    options
  )
useUserTextQuery.getKey = (variables: UserTextQueryVariables) => [
  'UserText',
  variables,
]

useUserTextQuery.fetcher = (variables: UserTextQueryVariables) =>
  fetcher<UserTextQuery, UserTextQueryVariables>(UserTextDocument, variables)
export const CreateUserTextDocument = `
    mutation CreateUserText($id: String!, $title: String!, $text: String!) {
  createUserText(id: $id, title: $title, text: $text) {
    id
    title
    ...
    `
export const useCreateUserTextMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
    CreateUserTextMutation,
    TError,
    CreateUserTextMutationVariables,
    TContext
  >
) =>
  useMutation<
    ...
    TContext
  >(
    (variables?: CreateUserTextMutationVariables) =>
      fetcher<CreateUserTextMutation, CreateUserTextMutationVariables>(
        CreateUserTextDocument,
        variables
      )(),
    options
  )
...
export const MacronizeDocument = `
  ...
  macronize(text: $text)
    ...
    `
export const useMacronizeQuery = <TData = MacronizeQuery, TError = unknown>(
  variables: MacronizeQueryVariables,
  options?: UseQueryOptions<MacronizeQuery, TError, TData>
) =>
  useQuery<MacronizeQuery, TError, TData>(
    ['Macronize', variables],
    fetcher<MacronizeQuery, MacronizeQueryVariables>(
      MacronizeDocument,
      variables
    ),
    options
  )
useMacronizeQuery.getKey = (variables: MacronizeQueryVariables) => [
  'Macronize',
  variables,
]

useMacronizeQuery.fetcher = (variables: MacronizeQueryVariables) =>
...
export const SpeechDocument = `
  ...
  speech(text: $text)
    ...
    `
export const useSpeechQuery = <TData = SpeechQuery, TError = unknown>(
...
useSpeechQuery.getKey = (variables: SpeechQueryVariables) => [
  'Speech',
  variables,
]

useSpeechQuery.fetcher = (variables: SpeechQueryVariables) =>
  fetcher<SpeechQuery, SpeechQueryVariables>(SpeechDocument, variables)
