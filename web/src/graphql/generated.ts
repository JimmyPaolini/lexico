...
export type GetCustomTextQuery = { getCustomText: { id: string, title: string, text: string } };

export type ListCustomTextsQueryVariables = Exact<{ [key: string]: never; }>;


export type ListCustomTextsQuery = { listCustomTexts: Array<{ id: string, title: string, text: string }> };
...
export type GetAuthorsQuery = { getAuthors: Array<{ id: string, name: string, books?: Maybe<Array<{ id: string, title: string, texts: Array<{ id: string, title: string }> }>>, texts: Array<{ id: string, title: string }> }> };
...
export type GetTextQuery = { getText: { id: string, title: string, lines: Array<{ id: string, line: string, lineNumber: number, lineLabel: string }>, book?: Maybe<{ id: string, title: string }>, author: { id: string, name: string } } };
...
export type GetTextsQuery = { getTexts: Array<{ id: string, title: string, author: { name: string }, book?: Maybe<{ id: string, title: string }> }> };
...
export type UserQuery = { user?: Maybe<{ id: string, email: string, settings?: Maybe<{ theme?: Maybe<string>, fontSize?: Maybe<number>, formsExpandedDefault?: Maybe<boolean>, translationsExpandedDefault?: Maybe<boolean>, dictionaryMacronized?: Maybe<boolean>, literatureMacronized?: Maybe<boolean> }> }> };
...
useGetCustomTextQuery.getKey = (variables: GetCustomTextQueryVariables) => ['GetCustomText', variables];

useGetCustomTextQuery.fetcher = (variables: GetCustomTextQueryVariables) => fetcher<GetCustomTextQuery, GetCustomTextQueryVariables>(GetCustomTextDocument, variables);
...
useListCustomTextsQuery.getKey = (variables?: ListCustomTextsQueryVariables) => ['ListCustomTexts', variables];

useListCustomTextsQuery.fetcher = (variables?: ListCustomTextsQueryVariables) => fetcher<ListCustomTextsQuery, ListCustomTextsQueryVariables>(ListCustomTextsDocument, variables);
...
useGetAuthorsQuery.getKey = (variables?: GetAuthorsQueryVariables) => ['GetAuthors', variables];

useGetAuthorsQuery.fetcher = (variables?: GetAuthorsQueryVariables) => fetcher<GetAuthorsQuery, GetAuthorsQueryVariables>(GetAuthorsDocument, variables);
...
useGetTextQuery.getKey = (variables: GetTextQueryVariables) => ['GetText', variables];

useGetTextQuery.fetcher = (variables: GetTextQueryVariables) => fetcher<GetTextQuery, GetTextQueryVariables>(GetTextDocument, variables);
...
useGetTextIdsQuery.getKey = (variables?: GetTextIdsQueryVariables) => ['GetTextIds', variables];

useGetTextIdsQuery.fetcher = (variables?: GetTextIdsQueryVariables) => fetcher<GetTextIdsQuery, GetTextIdsQueryVariables>(GetTextIdsDocument, variables);
...
useGetTextsQuery.getKey = (variables?: GetTextsQueryVariables) => ['GetTexts', variables];

useGetTextsQuery.fetcher = (variables?: GetTextsQueryVariables) => fetcher<GetTextsQuery, GetTextsQueryVariables>(GetTextsDocument, variables);
