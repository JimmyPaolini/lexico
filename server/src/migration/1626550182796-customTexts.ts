...
export class customTexts1626550182796 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "custom_text" ("id" character varying NOT NULL, "title" character varying(100) NOT NULL, "text" character varying(100000) NOT NULL, "userId" uuid, CONSTRAINT "PK_d6817b722963bd530f4594f6c7e" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
